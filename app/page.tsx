  ...
  return (
    <React.Fragment>
      ...
      <section className="mt-14">
        ...
        <div className="mt-8 flex flex-wrap justify-start gap-6 sm:mt-10 sm:justify-center sm:gap-10">
            ...
            <BlurFade key={index} delay={BLUR_FADE_DELAY * (18 + index)}>
              <div className="flex gap-x-3">
                ...
                <div>
                  <Link
                    href={cont.link}
                    target={cont.label === "+44 742 4947889" ? "_blank" : ""}
                    className={cn(cont.link === "#" && "cursor-default")}
                  >
            ...
            <div className="flex flex-row items-center gap-x-2.5">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <ModeToggle className="size-auto px-0" />
                </TooltipTrigger>
                <TooltipContent>
                  <p>Theme toggle</p>
                </TooltipContent>
