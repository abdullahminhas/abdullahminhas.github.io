        ...
        {experience.map((item, index) => {
          ...
          return (
            <BlurFade
              ...
              className="group relative grid grid-cols-[20px_1fr] gap-x-4 sm:grid-cols-[35px_1fr] sm:gap-x-6"
            >
              ...
              <div>
                ...
                >
                  ...
                  <ChevronRight className="size-4 shrink-0 translate-x-0 opacity-0 transition-all duration-300 ease-out group-hover/link:translate-x-1 group-hover/link:opacity-100" />
                </Link>

                <Link
                  href={item.link}
                  className="mt-0.5 flex flex-col sm:items-center justify-between gap-0.75 sm:gap-2 text-sm text-muted-foreground sm:flex-row"
                ...
                >
                  <div className="flex items-center gap-1">
                    ...
                    <ChevronRight
                      className={cn(
                        "chevron-tilt size-4 opacity-0 group-hover:opacity-100",
                ...
                >
                  <p className="mt-3 max-w-xl pb-4 text-[13px] leading-relaxed text-muted-foreground">
                    {item.description}
                  </p>
                </motion.div>
